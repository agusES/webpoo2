...
public class ActividadSimpleController {
    ...
    private ActividadSimple actividadSeleccionada;
    ...
    public List<ActividadSimple> getActividadesSimples() {
        return simpleb.getAll();
    }

    public void addImpacto() {
        this.actividadSeleccionada.addI(peso, objetivoSeleccionado);
        simpleb.Update(this.actividadSeleccionada);
    }

    public ActividadSimple getActividadSeleccionada() {
        return actividadSeleccionada;
    }

    public void setActividadSeleccionada(ActividadSimple actividadSeleccionada) {
